...
import { setIsLogin, selectIsLogin } from '../../globalStates/dataSlice'; // Import Redux actions and selectors
...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                // Set the login state with an expiration time of 24 hours
            ...
            // Handle login error, e.g., display a toaster message
    ...
    const validateEmail = (email) => {
        // Email validation logic, you can use a library or regex for a more comprehensive check
        // For a basic check, you can use a regex pattern like this:
                ...
                <div className="lg:w-1/2 xl:max-w-screen-sm">
                    <div className="pt-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                        <div className="cursor-pointer flex items-center">
                            <div>
                                <Image
                                    src="/credit_logo.png" // Path to your image
                                    alt="Description of the image"
                                    width={100} // Width of the displayed image
                                    height={100} // Height of the displayed image
                                />
                            </div>
                        </div>
                    </div>
                    <div className="px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-10 xl:px-24 xl:max-w-2xl">
                        <h2 className="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-3xl xl:text-bold">Log in</h2>
                        <div className="mt-12">
