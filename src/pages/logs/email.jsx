...
import { GET_EMAIL_LOGS, GET_LEAD_WISE_EMAIL_LOGS } from "@/utils/ApiRoutes";
...
export default function Logs() {
    ...
    useEffect(() => {
        ...
        axios.post(GET_EMAIL_LOGS, { currentPage, pageSize, dateRange }).then((res) => {
    ...
    useEffect(() => {
        ...
        if (selectedLead != 0) {
            ...
            axios.post(GET_LEAD_WISE_EMAIL_LOGS, { selectedLead }).then((res) => {
